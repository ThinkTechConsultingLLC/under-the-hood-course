# Lab — M11: train your own AI and watch it learn
...
## 🎉 Your win
You trained your own AI from examples and watched it **learn** (training) and **predict** live (inference)
— and saw firsthand how its examples (and their bias) shape what it can do.
